...
\DeclareDocumentCommand \EXAMPLE { }
  {
    ...
    Frère Jacques, Frère Jacques, \par
    Dor\-mez-vous? Dor\-mez-vous? \par
    Sonnez les matines! Sonnez les matines! \par
    Ding, dang, dong. Ding, dang, dong. \par
  ...
  \begin{function}{wrapstuff}
    ...
    \begin{Example}[frame=single,numbers=none,gobble=5]
      \begin{wrapstuff}[c,top=1]
        \includegraphics[width=\dimeval{\linewidth/4}]{example-image.pdf}
      \end{wrapstuff}
      \lipsum[2]
    \end{Example}
  \end{function}
